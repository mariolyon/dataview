...
export function mapMeasurementModelToMeasurement(model: MeasurementModel): Measurement {
  return {
    ...model,
...
export function getNextButtonText(page: number, lastPage: number, isFetching: boolean): string {
